...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    if output.status.success() {
        ...
        build_licenses_from_json("../src/licenses.rs")?;
        build_exceptions_from_json("../src/exceptions.rs")?;
...
fn build_licenses_from_json(path: &str) -> Result<(), Box<dyn Error>> {
...
fn build_exceptions_from_json(path: &str) -> Result<(), Box<dyn Error>> {
    let inner = File::create(path)?;
